    ...
    <main className="min-h-screen overflow-x-hidden bg-slate-50 p-3 sm:p-4 lg:p-8">
      ...
      <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <Link to="/le-syndicat" className="flex items-center gap-3 hover:opacity-80 transition-opacity"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-red-50"><Phone className="h-5 w-5 text-red-600" /></div><div><p className="text-sm font-semibold text-slate-500 italic">Bientôt</p><p className="text-xs text-slate-500">Voir nos représentants →</p></div></Link>
